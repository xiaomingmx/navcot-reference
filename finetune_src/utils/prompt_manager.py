...
class PromptManager(object):
    ...
    def make_action_options(self, cand_inputs, t):
        ...
        for i in range(batch_size):
            ...
            only_actions_batch.append(actions)

        return action_options_batch, only_options_batch, only_actions_batch
    ...
    def make_history(self, a_t, nav_input, t):
        ...
        for i in range(batch_size):
            ...
            last_action = nav_input["only_actions"][i][a_t[i]+1]
            self.history[i] = 'Step ' + str(t+1) +". "+ last_action


    def get_prompt(self, obs, cand_inputs, mode, t):
        batch_size = len(obs)
        # action_options:"A. go forward to kitchen B. go..."  only_optsions:"A"
        action_options_batch, only_options_batch, only_actions_batch = self.make_action_options(cand_inputs, t=t)
        prompt_query_batch = []
        prompt_batch = []
        ...
        for i in range(batch_size):
            ...
            prompt_query_batch.append(query)
            prompt_batch.append(prompt)
        
        nav_input = {
            "prompts" : prompt_batch,
            "prompt_query": prompt_query_batch,
    ...
    def get_output(self, nav_output, only_options_batch, cand_inputs, t):
        ...
        for i in range(batch_size):
            ...
            if index == -1:
                ...
                output_batch.append(only_options_batch[i][output_index])
            else:
        ...
        # print(f"output_index_batch: {output_index_batch}")
