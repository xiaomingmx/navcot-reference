...
outdir=/root/autodl-tmp/navcot/NavCoT/finetune_src/datasets/R2R/exprs/finetune/agent/r4r/finetuned_model-r4r
...
CUDA_VISIBLE_DEVICES='0' torchrun --master_port 12229 --nproc_per_node 1 r2r/main.py $flag  \
      --llm_predict --stop_first --pretrained_path /root/autodl-tmp/navcot/NavCoT/finetune_src/datasets/R2R/exprs/finetune/agent/r4r/finetuned_model-r4r/epoch1 \
