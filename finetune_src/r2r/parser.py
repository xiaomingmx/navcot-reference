...
def parse_args():
    ...
    parser.add_argument('--root_dir', type=str, default='/root/autodl-tmp/navcot/NavCoT/finetune_src/datasets/')
    parser.add_argument(
    ...
    parser.add_argument("--use_native_best_of_n", action='store_true', default=False)
    ...
    parser.add_argument('--hf_model_path', default=None, type=str,
