...
import sys
# 添加项目根目录到Python路径
sys.path.append('/root/autodl-tmp/navcot/NavCoT')
sys.path.append('/root/autodl-tmp/navcot/Data_prepar')
# 或者使用相对路径
# sys.path.append('../..')
...
from dall_e.encoder import Encoder as Dalle_VAE
...
def build_dataset(args, rank=0, is_test=False):
    ...
    if args.llm_predict:
        ...
        val_env_names = ['val_unseen','val_seen','val_train_seen']
